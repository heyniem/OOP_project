...
public class Sprite {
    ...
    public static Sprite brick_destroyed_1 = new Sprite(DEFAULT_SIZE, 7, 1, SpriteSheet.tiles, 16, 16);
    public static Sprite brick_destroyed_2 = new Sprite(DEFAULT_SIZE, 7, 2, SpriteSheet.tiles, 16, 16);
    public static Sprite brick_destroyed_3 = new Sprite(DEFAULT_SIZE, 7, 3, SpriteSheet.tiles, 16, 16);
    ...
    public static Sprite bomb_0 = new Sprite(DEFAULT_SIZE, 0, 3, SpriteSheet.tiles, 15, 15);
